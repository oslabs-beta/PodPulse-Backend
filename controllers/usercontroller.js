...
userController.login = async (req, res, next) => {
    ...
    const passwordQuery = await query(`SELECT password FROM USER_TABLE WHERE USERNAME = '${userName}'`)
    ...
    const queryResult = await bcrypt.compare(
        ...
        try{
            ...
            const token = jwt.sign({ payload: {id: userName} }, process.env.JWT_SECRET, {
